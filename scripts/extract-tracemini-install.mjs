...
replace('<Copy label="Connect or sync command" command={installation.syncCommand || installation.installCommand} />','<Copy label="Private install command" command={installation.installCommand} />\n              <button className="button secondary" onClick={mint} disabled={pending}>Generate a new command</button>');
