export default function NexusMark({ className = '' }: { className?: string }) {
  return <svg className={className} viewBox="0 0 64 64" fill="none" aria-hidden="true" focusable="false">
    ...
    <path className="nexusMarkOuter" d="M12 23a22 22 0 0 1 40 0" stroke="#B9A9FF" strokeWidth="4" strokeLinecap="round" />
    <path className="nexusMarkInner" d="M22 24a13 13 0 1 1-1 16" stroke="#FAF8FF" strokeWidth="5" strokeLinecap="round" />
