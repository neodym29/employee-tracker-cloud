...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.command == 'run-once':
        ...
        collector = ActivityCollector(
            ...
            screenshot_activity_idle_seconds=settings.screenshot_activity_idle_seconds,
            screenshot_similarity_threshold=settings.screenshot_similarity_threshold,
            ...
            state_snapshot_interval_seconds=settings.state_snapshot_interval_seconds,
            ...
            clipboard_max_text_chars=settings.clipboard_max_text_chars,
