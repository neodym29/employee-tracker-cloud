...
assert.match(db, /truncate table activity_screenshots, activity_events, devices restart identity/, 'telemetry wipe should clear cloud activity data efficiently');
